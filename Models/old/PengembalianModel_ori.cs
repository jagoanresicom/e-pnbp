...
namespace Pnbp.Models
{
    public class PengembalianModel
    {
        ...
        public List<Entities.PengembalianPnbpTrain> GetPengembalianPnbpTrain(string kantoriduser, string namakantor, string judul, string nomorberkas, string kodebilling, string nptn, string namapemohon, string nikpemohon, string alamatpemohon, string teleponpemohon, string bankpersepsi, string status, string namasatker, string kodesatker, int from, int to)
        {
            ...
            string query =
                @"SELECT * FROM (
                    ...
                    FROM
                        ...
                        AND pengembalianpnbp.kantorid IN (SELECT kantorid FROM kantor START WITH kantorid = :KantorIdUser CONNECT BY NOCYCLE PRIOR kantorid = induk) WHERE  berkaskembalian.nomorsurat is not null ";
        ...
        public Entities.GetDataBerkasForm GetDataBerkasByNo(string NoTahun)
        {
            ...
            string query =
                @"WITH AA AS (SELECT 
                    ...
                    FROM BERKAS 
                     JOIN REKAPPENERIMAANDETAIL ON BERKAS.BERKASID = REKAPPENERIMAANDETAIL.BERKASID
                     JOIN KKPWEB.PEMILIK ON BERKAS.PEMILIKID = PEMILIK.PEMILIKID
