 ...
 (function () {
  ...
  (function (root, factory) {
   ...
   function configure(PDFJS) {
    ...
    PDFJS.workerSrc = '../resources/js/pdf.worker.min.js';
...
/* dentall add */
(function (d, dg) { d.onreadystatechange = function () { dg("openFile").style.display = dg("secondaryOpenFile").style.display = dg("viewBookmark").style.display = dg("secondaryViewBookmark").style.display = "none"; }; }(document, document.getElementById.bind(document)));
/* end dentall add */
